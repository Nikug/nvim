...
local set_keymap = require("user.utils").set_keymap
...
set_keymap("v", "<M-j>", [[<Esc><Cmd>lua require("user.utils").vscode_move_lines("Down")<CR>]])

-- Move line/lines up
set_keymap("n", "<M-k>", '<Cmd>call VSCodeCall("editor.action.moveLinesUpAction")<CR>')
set_keymap("v", "<M-k>", [[<Esc><Cmd>lua require("user.utils").vscode_move_lines("Up")<CR>]])
